...
a persistence unit "srv-mobile-repositoryPersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/cl/ddiaz/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "srv-mobile-repository/pom.xml":
...
artifacts ("srv-mobile-repository-ejb.jar" and "srv-mobile-repository-web.war") are already built. You can build
